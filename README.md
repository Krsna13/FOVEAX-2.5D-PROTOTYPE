...
🖥️ **Run Desktop GUI**: Double-click `Launch_GUI.bat` or run `python src/13_realtime_dashboard.py`

## 🚀 Live GUI Running Demo

![FOVEAX 2.5D Real-Time Perception Dashboard Running](outputs/phase9/foveax_gui_running.gif)
